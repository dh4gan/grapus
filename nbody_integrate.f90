...
real,dimension(3,nbodies),intent(out) :: newposition,newvelocity
real,dimension(3,nbodies) :: nextpos,nextvel
real,dimension(3,nbodies) :: k1vel, k2vel, k3vel, k4vel
real,dimension(3,nbodies) :: k1pos, k2pos, k3pos, k4pos
...
call nbody_acceleration(nextpos,nextvel,k3vel)
...
call nbody_acceleration(nextpos,nextvel,k4vel)
